        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<int>(type: "int", nullable: false),
                    UsuarioQueRecibeId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetalleRemitos_Usuarios_UsuarioQueRecibeId",
                        column: x => x.UsuarioQueRecibeId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleRemitos_UsuarioQueRecibeId",
                table: "DetalleRemitos",
                column: "UsuarioQueRecibeId");
